...
def main():
    ...
    parser.add_argument('--model_url', default=glob['ResnetModelURL'], help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    if (args.use_lpips_loss > 0.00000001):
        with dnnlib.util.open_url(glob['ResnetModelURL'], cache_dir=config.cache_dir) as f:
