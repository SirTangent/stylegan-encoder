...
def main():
    ...
    tasks = []
    tasks += [EasyDict(run_func_name='run_metrics.run_pickle', network_pkl=glob['ResnetModelURL'], dataset_args=EasyDict(tfrecord_dir='ffhq', shuffle_mb=0), mirror_augment=True)] # karras2019stylegan-ffhq-1024x1024.pkl
